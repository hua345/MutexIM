...
public:
	...
	//消息回调类型
	typedef std::function<void(const TSessionPtr&, const shared_ptr_Msg&)> ProtobufMessageCallback;
	...
	//找到消息类型对应的处理函数
	void HandleMessage(TSessionPtr connection, std::shared_ptr<CMessage> ptrMsg) const
	{
